...
public class AndroidConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new AndroidPreparedStatement(db, sql);
    }
    ...
    public void close() throws SQLException {
        // We typically don't close the DB here as it might be managed elsewhere,
        // but if needed: db.close();
    }
    ...
    @Override public void commit() throws SQLException { db.setTransactionSuccessful(); db.endTransaction(); }
    @Override public void rollback() throws SQLException { db.endTransaction(); }
    @Override public boolean isClosed() throws SQLException { return !db.isOpen(); }
    @Override public DatabaseMetaData getMetaData() throws SQLException { return null; }
    @Override public void setReadOnly(boolean readOnly) throws SQLException { }
    @Override public boolean isReadOnly() throws SQLException { return db.isReadOnly(); }
    ...
    @Override public boolean isValid(int timeout) throws SQLException { return db.isOpen(); }
